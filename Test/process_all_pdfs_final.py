#!/usr/bin/env python3
"""
Process all PDFs in the data directory and add to vector and knowledge graph databases, then generate reports.
"""
...
async def main():
    """Main function to process all PDFs in the data directory and generate reports."""
