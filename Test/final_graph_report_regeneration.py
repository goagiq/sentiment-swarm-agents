#!/usr/bin/env python3
"""
Final comprehensive test script to regenerate the knowledge graph report 
with all improvements applied (entity extraction, relationship mapping, visualization).
"""
...
async def final_graph_report_regeneration():
    """Regenerate the knowledge graph report with all improvements."""
    ...
    print("=== Final Knowledge Graph Report Regeneration ===")
    ...
    try:
        ...
        if result.status == "completed":
            ...
            print("\n--- Generating Final Graph Report ---")
            
            # Set output path for the report
            output_path = "Results/reports/final_improved_knowledge_graph_report.md"
            ...
            # Generate PNG report
            png_output = "Results/reports/final_improved_knowledge_graph_report.png"
            ...
            html_output = "Results/reports/final_improved_knowledge_graph_report.html"
        ...
        print("\n=== Final Report Regeneration Complete ===")
        
    except Exception as e:
        print(f"❌ Final report regeneration failed with error: {e}")
        import traceback
        traceback.print_exc()

if __name__ == "__main__":
    asyncio.run(final_graph_report_regeneration())
