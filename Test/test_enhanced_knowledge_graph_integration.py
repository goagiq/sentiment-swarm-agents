...
def generate_enhanced_html_report(G, output_path="Results/enhanced_knowledge_graph_report.html"):
    """Generate an enhanced HTML report for the knowledge graph."""
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>Interactive analysis of knowledge graph with meaningful relationships</p>
        </div>
...
def main():
    ...
    # Generate enhanced HTML report in Results directory
    print(f"\nGenerating enhanced HTML report in Results directory...")
    output_path = generate_enhanced_html_report(G)
    print(f"Enhanced HTML report generated: {output_path}")
    
    # Save graph data as JSON in Results directory
    graph_data = {
        "entities": entities,
    ...
    json_path = "Results/enhanced_knowledge_graph_data.json"
    with open(json_path, "w", encoding="utf-8") as f:
        json.dump(graph_data, f, ensure_ascii=False, indent=2)
    
    print(f"Graph data saved to: {json_path}")
    print(f"\n✅ Enhanced knowledge graph successfully created and stored in Results/ directory!")
    print(f"📊 Graph contains {G.number_of_nodes()} entities and {G.number_of_edges()} relationships")
