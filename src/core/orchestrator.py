...
class SentimentOrchestrator:
    ...
    async def _process_with_reflection(
        ...
        for iteration in range(request.max_iterations):
            ...
            if confidence < request.confidence_threshold and iteration < request.max_iterations - 1:
                ...
                for alt_request in alternatives:
                    ...
                    if alt_result.sentiment.confidence > confidence:
                        ...
                        reflection_note += f", found better alternative (confidence: {confidence:.3f})"
